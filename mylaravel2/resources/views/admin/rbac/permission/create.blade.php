...
<div class="row">
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="{{ route('admin.rbac.permission.create') }}">添加权限</a></li>
    </ul>
    ...
    <div class="">
        <div class="tab-panel fade in active" id="tab1">
            ...
            <form class="form-horizontal" action="{{ route('admin.rbac.permission.store') }}" method="POST">
